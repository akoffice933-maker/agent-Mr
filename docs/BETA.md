...
> Для пилотных агентств на Яндекс.Директе. Google Ads create_campaign — проверено в sandbox (114+ тестов), живой боевой E2E ещё не проводился. Авито — строгий read-back в коде, партнёрский доступ к Business API оформляется отдельно.
...
- Google Ads: только supervised sandbox-прогон create_campaign пройден тестами; живой E2E на боевом кабинете ещё не проводился (по аналогии с `docs/YANDEX_E2E.md`, план — Phase 2.2)
- Авито: партнёрский доступ к Business API всё ещё нужно оформить отдельно; строгий read-back статуса/продвижения уже в коде, но не проверялся против боевого кабинета
